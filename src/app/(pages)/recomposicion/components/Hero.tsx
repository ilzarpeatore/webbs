        ...
        <div className="grid grid-cols-1 items-center gap-7.5 md:grid-cols-2 lg:gap-15">
          ...
          <div className="relative">
            ...
            <div className="bg-default-900/70 absolute right-3 bottom-3 flex items-center gap-3 rounded-2xl border border-white/10 p-3.5 backdrop-blur-md md:right-5 md:bottom-5 md:p-5">
              <div className="bg-primary-6 flex size-9 shrink-0 items-center justify-center rounded-full md:size-11">
                <Icon icon="lucide:ruler" className="text-lg text-white" />
              </div>
              <p className="text-sm font-medium text-white md:text-base">Medidas y % de grasa, no solo el peso</p>
            </div>
          </div>
        </div>
      </div>
